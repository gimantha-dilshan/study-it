    ...
    return (
      <main className="min-h-screen flex items-center justify-center p-4 bg-[#0a0a0a] overflow-hidden relative text-white font-sans">
        ...
        <div className="relative z-10 w-full max-w-md glass p-10 rounded-[2.5rem] space-y-8 border border-white/20 shadow-2xl backdrop-blur-3xl bg-white/5">
          <div className="text-center space-y-2"><h1 className="text-4xl font-bold tracking-tight glow-text">Admin Login</h1><p className="text-gray-400 font-medium">Study-It V2 Dashboard</p></div>
            ...
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-white/5">
                {filteredUsers.map((user) => {
                  ...
                  return (
                    <tr key={user.jid} className="hover:bg-white/[0.02] transition-all group">
                      <td className="px-10 py-6">
                        <div className="flex items-center gap-4">
                          ...
                          <div><div className="font-bold text-white text-lg tracking-tight">{user.name || "Pupil Node"}</div><div className="text-[10px] text-gray-500 font-bold tracking-tight">#{user.phone || user.jid.split('@')[0]}</div></div>
                        </div>
                      </td>

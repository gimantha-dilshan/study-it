      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            ...
            <a href="https://wa.me/INSERT_BOT_NUMBER_HERE?text=Hello%20Study-It!" target="_blank" rel="noreferrer" className="px-8 py-4 glass border border-green-500/40 rounded-2xl text-white font-bold hover:bg-green-500/10 transition-all text-center flex items-center justify-center gap-3">
